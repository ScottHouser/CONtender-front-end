...
function App({...props}) {
  ...
  return (
    ...
    <div className={'Container'}>
      ...
      <button id='btn1' onClick={handleClick1} className={'btn'}>JOIN GAME</button>
      
      <button onClick={handleClick2} className={'btn'}>CREATE GAME</button>
